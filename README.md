...
> **UOM – Assignment 4** | Single-Cycle ➜ 2-Stage Pipeline + (Optional) Data Forwarding
...
![2-Stage-Pipelined-RISC-V-RV32I-Processor](single_cycle_cpu_diagram.png)

### Converting Single-Cycle ➜ 2-Stage Pipelined CPU Diagram
![2-Stage-Pipelined-RISC-V-RV32I-Processor](Converting Single-Cycle CPU into a 2-Stage Pipelined CPU Diagram.jpeg)
